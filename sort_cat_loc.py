#Author: Eric Shore
#Purpose: To sort the 2MASS catalogue into different files based on position on the sky, and magnitude (for "slow" method outlined in "Method Writeup.txt")
import numpy as np
...
for i in range(92):
	...
	cat_part = open("../psc_"+string,mode="r") 
        #loop through file
	while(True):
    		try: #attempt to read from file, if this fails, then we are at the end of the file
                        #read a line
